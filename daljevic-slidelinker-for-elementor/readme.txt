...
* Initial public release under the `Daljevic SlideLinker for Elementor` package
...
* Rebranded the plugin with a distinctive slug and text domain for WordPress.org submission
* Replaced generic declarations and stored keys with a plugin-specific prefix
